...
$string['whitelist_empty'] = 'No hay campos en lista blanca.';
$string['whitelist_field'] = 'Campo';
$string['whitelist_remove'] = 'Eliminar de Lista Blanca';
$string['whitelist_removed'] = 'Campo eliminado de lista blanca.';
$string['whitelist_table'] = 'Tabla';
$string['whitelist_this_field'] = 'Marcar como seguro (lista blanca)';
$string['whitelist_tooltip'] = '{$a} campo(s) PII detectado(s) — Clic para gestionar lista blanca';
