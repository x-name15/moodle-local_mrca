...
$string['csv_header_report_title'] = 'Rapport de risque et conformité MRCA';
$string['csv_header_risk_level'] = 'Niveau de risque';
$string['csv_header_risk_score'] = 'Score de risque';
$string['csv_label_no'] = 'No';
$string['csv_label_plugins_scanned'] = 'Plugins analysés';
$string['csv_label_roles_scanned'] = 'Rôles analysés';
$string['csv_label_scan_date'] = 'Date de l’analyse';
$string['csv_label_site_risk_index'] = 'Indice de risque du site';
$string['csv_label_total_score'] = 'Score total';
...
$string['dep_func_add_to_log'] = 'Remplacé par Events API (\\core\\event).';
$string['dep_func_choose_from_menu'] = 'Remplacé par html_writer::select().';
$string['dep_func_events_trigger'] = 'Remplacé par Events 2 API.';
$string['dep_func_get_context_instance'] = 'Utiliser context_*::instance() à la place.';
$string['dep_func_helpbutton'] = 'Remplacé par $OUTPUT->help_icon().';
$string['dep_func_print_error'] = 'Utiliser throw new moodle_exception() à la place.';
$string['dep_func_print_footer'] = 'Remplacé par $OUTPUT->footer().';
$string['dep_func_print_header'] = 'Remplacé par $OUTPUT->header().';
$string['dep_func_print_heading'] = 'Remplacé par $OUTPUT->heading().';
$string['dep_func_print_object'] = 'Utiliser debugging() ou var_dump pour le débogage.';
$string['dep_func_print_recent_activity_note'] = 'Fonction d\'activité obsolète.';
$string['dep_func_print_simple_box'] = 'Fonction UI obsolète.';
$string['dep_func_print_table'] = 'Remplacé par html_writer::table().';
...
$string['unsafe_func_dl'] = 'Chargement dynamique d\'extension.';
$string['unsafe_func_eval'] = 'Risque d\'exécution de code arbitraire.';
$string['unsafe_func_exec'] = 'Exécution de commande système.';
$string['unsafe_func_mysql_connect'] = 'Extension MySQL obsolète. Utiliser l\'API $DB.';
$string['unsafe_func_mysql_query'] = 'Extension MySQL obsolète. Utiliser l\'API $DB.';
$string['unsafe_func_mysqli_query'] = 'Accès direct à la BD. Utiliser l\'API $DB de Moodle.';
$string['unsafe_func_passthru'] = 'Exécution de commande système.';
$string['unsafe_func_popen'] = 'Exécution de processus.';
$string['unsafe_func_proc_open'] = 'Exécution de processus.';
$string['unsafe_func_shell_exec'] = 'Exécution de commande système.';
...
$string['whitelist_all_fields'] = 'Tout Marquer ({$a} Champs)';
$string['whitelist_component'] = 'Composant';
$string['whitelist_desc'] = 'Les champs marqués comme sûrs seront exclus des futurs scans.';
$string['whitelist_empty'] = 'Aucun champ en liste blanche.';
...
$string['whitelist_this_field'] = 'Marquer comme sûr (liste blanche)';
$string['whitelist_tooltip'] = '{$a} champ(s) PII détecté(s) — Cliquez pour gérer la liste blanche';
