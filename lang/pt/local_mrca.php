...
$string['csv_header_report_title'] = 'Relatório de risco e conformidade - MRCA';
$string['csv_header_risk_level'] = 'Nível de risco';
$string['csv_header_risk_score'] = 'Pontuação de risco';
$string['csv_label_no'] = 'No';
$string['csv_label_plugins_scanned'] = 'Plugins analisados';
$string['csv_label_roles_scanned'] = 'Papéis analisados';
$string['csv_label_scan_date'] = 'Data da análise';
$string['csv_label_site_risk_index'] = 'Índice de risco do site';
$string['csv_label_total_score'] = 'Pontuação total';
...
$string['dep_func_add_to_log'] = 'Substituído por Events API (\\core\\event).';
$string['dep_func_choose_from_menu'] = 'Substituído por html_writer::select().';
$string['dep_func_events_trigger'] = 'Substituído por Events 2 API.';
$string['dep_func_get_context_instance'] = 'Usar context_*::instance() em vez disso.';
$string['dep_func_helpbutton'] = 'Substituído por $OUTPUT->help_icon().';
$string['dep_func_print_error'] = 'Usar throw new moodle_exception() em vez disso.';
$string['dep_func_print_footer'] = 'Substituído por $OUTPUT->footer().';
$string['dep_func_print_header'] = 'Substituído por $OUTPUT->header().';
$string['dep_func_print_heading'] = 'Substituído por $OUTPUT->heading().';
$string['dep_func_print_object'] = 'Usar debugging() ou var_dump para depuração.';
$string['dep_func_print_recent_activity_note'] = 'Função de atividade obsoleta.';
$string['dep_func_print_simple_box'] = 'Função UI obsoleta.';
$string['dep_func_print_table'] = 'Substituído por html_writer::table().';
...
$string['mih_missing_note'] = 'Integration Hub for Moodle™ (local_integrationhub) não está instalado. <a href="https://github.com/x-name15/moodle-local_integrationhub/releases" target="_blank">Descarregue-o no GitHub</a> para capacidades avançadas de integração (recomendado).';
...
$string['unsafe_func_dl'] = 'Carregamento dinâmico de extensões.';
$string['unsafe_func_eval'] = 'Risco de execução arbitrária de código.';
$string['unsafe_func_exec'] = 'Execução de comandos do sistema.';
$string['unsafe_func_mysql_connect'] = 'Extensão MySQL obsoleta. Usar a API $DB.';
$string['unsafe_func_mysql_query'] = 'Extensão MySQL obsoleta. Usar a API $DB.';
$string['unsafe_func_mysqli_query'] = 'Acesso direto à BD. Usar a API $DB do Moodle.';
$string['unsafe_func_passthru'] = 'Execução de comandos do sistema.';
$string['unsafe_func_popen'] = 'Execução de processos.';
$string['unsafe_func_proc_open'] = 'Execução de processos.';
$string['unsafe_func_shell_exec'] = 'Execução de comandos do sistema.';
...
$string['whitelist_all_fields'] = 'Marcar Todos ({$a} Campos)';
$string['whitelist_component'] = 'Componente';
$string['whitelist_desc'] = 'Campos marcados como seguros serão excluídos de varreduras futuras.';
$string['whitelist_empty'] = 'Nenhum campo na lista branca.';
...
$string['whitelist_this_field'] = 'Marcar como seguro (lista branca)';
$string['whitelist_tooltip'] = '{$a} campo(s) PII detectado(s) — Clique para gerenciar lista branca';
