...
$string['csv_header_report_title'] = 'MRCA — Report di rischio e conformità';
$string['csv_header_risk_level'] = 'Livello di rischio';
$string['csv_header_risk_score'] = 'Punteggio di rischio';
$string['csv_label_no'] = 'No';
$string['csv_label_plugins_scanned'] = 'Plugin analizzati';
$string['csv_label_roles_scanned'] = 'Ruoli analizzati';
$string['csv_label_scan_date'] = 'Data della scansione';
$string['csv_label_site_risk_index'] = 'Indice di rischio del sito';
$string['csv_label_total_score'] = 'Punteggio totale';
$string['csv_label_yes'] = 'Sì';
...
$string['dep_func_add_to_log'] = 'Sostituito da Events API (\\core\\event).';
$string['dep_func_choose_from_menu'] = 'Sostituito da html_writer::select().';
$string['dep_func_events_trigger'] = 'Sostituito da Events 2 API.';
$string['dep_func_get_context_instance'] = 'Usare context_*::instance() invece.';
$string['dep_func_helpbutton'] = 'Sostituito da $OUTPUT->help_icon().';
$string['dep_func_print_error'] = 'Usare throw new moodle_exception() invece.';
$string['dep_func_print_footer'] = 'Sostituito da $OUTPUT->footer().';
$string['dep_func_print_header'] = 'Sostituito da $OUTPUT->header().';
$string['dep_func_print_heading'] = 'Sostituito da $OUTPUT->heading().';
$string['dep_func_print_object'] = 'Usare debugging() o var_dump per il debug.';
$string['dep_func_print_recent_activity_note'] = 'Funzione attività obsoleta.';
$string['dep_func_print_simple_box'] = 'Funzione UI obsoleta.';
$string['dep_func_print_table'] = 'Sostituito da html_writer::table().';
...
$string['mih_missing_note'] = 'Integration Hub for Moodle™ (local_integrationhub) non è installato. <a href="https://github.com/x-name15/moodle-local_integrationhub/releases" target="_blank">Scaricalo da GitHub</a> per funzionalità di integrazione avanzate (raccomandato).';
...
$string['unsafe_func_dl'] = 'Caricamento dinamico di estensioni.';
$string['unsafe_func_eval'] = 'Rischio di esecuzione arbitraria di codice.';
$string['unsafe_func_exec'] = 'Esecuzione comandi di sistema.';
$string['unsafe_func_mysql_connect'] = 'Estensione MySQL deprecata. Utilizzare l\'API $DB.';
$string['unsafe_func_mysql_query'] = 'Estensione MySQL deprecata. Utilizzare l\'API $DB.';
$string['unsafe_func_mysqli_query'] = 'Accesso diretto al DB. Utilizzare l\'API $DB di Moodle.';
$string['unsafe_func_passthru'] = 'Esecuzione comandi di sistema.';
$string['unsafe_func_popen'] = 'Esecuzione di processi.';
$string['unsafe_func_proc_open'] = 'Esecuzione di processi.';
$string['unsafe_func_shell_exec'] = 'Esecuzione comandi di sistema.';
...
$string['whitelist_all_fields'] = 'Segna Tutti ({$a} Campi)';
...
$string['whitelist_this_field'] = 'Segna come sicuro (lista di esclusione)';
$string['whitelist_tooltip'] = '{$a} campo/i PII rilevato/i — Clicca per gestire lista di esclusione';
